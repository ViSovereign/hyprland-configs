...
hl.bind(mainMod .. " + SPACE",
    hl.dsp.exec_cmd("vicinae vicinae://toggle"))
...
-- Noctalia Related
--hl.bind(mainMod .. " + SHIFT + A", hl.dsp.exec_cmd(ipc .. "plugin:screen-toolkit annotate"))
...
hl.bind(mainMod .. " + SHIFT + W", hl.dsp.exec_cmd(noctalia .. "wallpaper-random DP-1"))
