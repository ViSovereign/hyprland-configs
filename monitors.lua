...
hl.monitor({ output = "DP-1", mode = "2560x1440@144", position = "1440x520", scale = 1 })
hl.monitor({ output = "DP-2", mode = "2560x1440@60", position = "0x0", scale = 1, transform = 3 })

--hl.monitor({ output = "DP-1", mode = "2560x1440@144", position = "0x0", scale = 1 })
--hl.monitor({ output = "DP-2", mode = "2560x1440@60", position = "-1440x-490", scale = 1, transform = 3 })
